        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent-555">
            ...
            <ul class="navbar-nav ml-auto nav-flex-icons">
                ...
                <li class="nav-item avatar dropdown">
                    <a class="nav-link dropdown-toggle p-0" id="navbarDropdownMenuLink-55" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="navbar-text white-text mr-2">
                            <?= $user['name']; ?>
                        </span>
                        <img style="object-fit:cover;" src=" <?= base_url('assets/img/profile/') . $user['image']; ?>" class="rounded-circle z-depth-0" alt="avatar image" height="35" width="35">
                    </a>
                    <div class=" dropdown-menu dropdown-menu-right dropdown-secondary" aria-labelledby="navbarDropdownMenuLink-55">
                        <a class="dropdown-item" href="<?= base_url('account'); ?>">Profil</a>
                        <?php if ($user['role_id'] == 1) : ?>
                            <a class="dropdown-item" href="<?= base_url('CEO'); ?>">CEO</a>
                        <?php endif; ?>
